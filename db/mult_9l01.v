//lpm_mult CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEDICATED_MULTIPLIER_CIRCUITRY="NO" DEVICE_FAMILY="Cyclone V" DSP_BLOCK_BALANCING="Auto" INPUT_A_IS_CONSTANT="NO" INPUT_B_IS_CONSTANT="NO" LPM_REPRESENTATION="UNSIGNED" LPM_WIDTHA=10 LPM_WIDTHB=14 LPM_WIDTHP=24 LPM_WIDTHS=1 MAXIMIZE_SPEED=5 dataa datab result CARRY_CHAIN="MANUAL" CARRY_CHAIN_LENGTH=48
...
module  mult_9l01
	...
	assign
		wire_sft10a_in = {w242w, {w242w, {w242w, {w242w, {w242w, {w_sum_node10w[71], {w_sum_node10w[70], {w_sum_node10w[69], {w_sum_node10w[68], {w_sum_node10w[67], {w_sum_node10w[66], {w_sum_node10w[65], {w_sum_node10w[64], {2{w242w}}}}}}}}}}}}}}};
	soft   sft11a_0
	( 
	...
	assign
		wire_sft5a_in = {w242w, {w242w, {w242w, {w242w, {wire_sft11a_out[14], {wire_sft11a_out[13], {wire_sft11a_out[12], {wire_sft11a_out[11], {wire_sft11a_out[10], {wire_sft11a_out[9], {wire_sft11a_out[8], {wire_sft11a_out[7], {wire_sft11a_out[6], {wire_sft11a_out[5], {wire_sft11a_out[4], {wire_sft11a_out[3], {wire_sft11a_out[2], {wire_sft11a_out[1], {wire_sft11a_out[0], {w_sum_node10w[33], {w_sum_node10w[32], {2{w242w}}}}}}}}}}}}}}}}}}}}}}};
	soft   sft6a_0
	( 
	...
	assign
		wire_sft8a_in = {w242w, {w_sum_node10w[47], {w_sum_node10w[46], {w_sum_node10w[73], {w_sum_node10w[72], {w_sum_node10w[57], {w_sum_node10w[56], {w_sum_node10w[55], {w_sum_node10w[54], {w_sum_node10w[53], {w_sum_node10w[52], {w_sum_node10w[51], {w_sum_node10w[50], {w_sum_node10w[49:48]}}}}}}}}}}}}}};
	soft   sft9a_0
	( 
	...
	assign
		wire_sft9a_in = {w242w, {w242w, {w242w, {w_sum_node10w[59], {w_sum_node10w[58], {w_sum_node10w[43], {w_sum_node10w[42], {w_sum_node10w[41], {w_sum_node10w[40], {w_sum_node10w[39], {w_sum_node10w[38], {w_sum_node10w[37], {w_sum_node10w[36], {w_sum_node10w[35:34]}}}}}}}}}}}}}};
	assign
		dataa_node = {datab[13:0]},
		datab_node = {dataa[9:0]},
		final_result_node = {w395w[23:0]},
		result = {final_result_node[23:0]},
		w242w = 1'b0,
		w395w = {wire_sft6a_out[22:21], wire_sft6a_out[20:19], wire_sft6a_out[18:17], wire_sft6a_out[16:15], wire_sft6a_out[14:13], wire_sft6a_out[12:11], wire_sft6a_out[10:9], wire_sft6a_out[8:7], wire_sft6a_out[6:5], wire_sft6a_out[4:3], wire_sft6a_out[2:1], wire_sft6a_out[0], w_sum_node10w[1], w_sum_node10w[0]},
