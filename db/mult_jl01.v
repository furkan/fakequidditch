...
module  mult_jl01
	...
	assign
		wire_sum_adder1aa_4dataa = {1'b0, w_decoder_node9w[189:171]},
		wire_sum_adder1aa_4datab = {{2{1'b0}}, w_decoder_node9w[170:153]};
	soft   sft10a_0
	( 
	...
	assign
		wire_sft10a_in = {w277w, {w277w, {w277w, {w277w, {w277w, {w_sum_node10w[96], {w_sum_node10w[95], {w_sum_node10w[94], {w_sum_node10w[93], {w_sum_node10w[92], {w_sum_node10w[91], {w_sum_node10w[90], {w_sum_node10w[89], {w_sum_node10w[88], {w_sum_node10w[87], {w_sum_node10w[86], {w_sum_node10w[85], {w_sum_node10w[84], {2{w277w}}}}}}}}}}}}}}}}}}}};
	soft   sft11a_0
	( 
	...
	assign
		wire_sft3a_in = {w277w, {w_sum_node10w[104], {w_sum_node10w[103], {w_sum_node10w[83], {w_sum_node10w[82], {w_sum_node10w[100], {w_sum_node10w[99], {w_sum_node10w[41], {w_sum_node10w[40], {w_sum_node10w[20], {w_sum_node10w[19], {w_sum_node10w[18], {w_sum_node10w[17], {w_sum_node10w[16], {w_sum_node10w[15], {w_sum_node10w[14], {w_sum_node10w[13], {w_sum_node10w[12], {w_sum_node10w[11], {w_sum_node10w[10], {w_sum_node10w[9], {w_sum_node10w[8], {w_sum_node10w[7], {w_sum_node10w[6], {w_sum_node10w[5], {w_sum_node10w[4], {w_sum_node10w[3:2]}}}}}}}}}}}}}}}}}}}}}}}}}}};
	soft   sft4a_0
	( 
	...
	assign
		wire_sft9a_in = {w277w, {w277w, {w277w, {w_sum_node10w[79], {w_sum_node10w[78], {w_sum_node10w[58], {w_sum_node10w[57], {w_sum_node10w[56], {w_sum_node10w[55], {w_sum_node10w[54], {w_sum_node10w[53], {w_sum_node10w[52], {w_sum_node10w[51], {w_sum_node10w[50], {w_sum_node10w[49], {w_sum_node10w[48], {w_sum_node10w[47], {w_sum_node10w[46], {w_sum_node10w[45:44]}}}}}}}}}}}}}}}}}}};
	assign
		dataa_node = {dataa[18:0]},
		datab_node = {datab[9:0]},
		final_result_node = {w470w[28:0]},
		result = {final_result_node[28:0]},
		w277w = 1'b0,
		w470w = {wire_sft6a_out[27:26], wire_sft6a_out[25:24], wire_sft6a_out[23:22], wire_sft6a_out[21:20], wire_sft6a_out[19:18], wire_sft6a_out[17:16], wire_sft6a_out[15:14], wire_sft6a_out[13:12], wire_sft6a_out[11:10], wire_sft6a_out[9:8], wire_sft6a_out[7:6], wire_sft6a_out[5:4], wire_sft6a_out[3:2], wire_sft6a_out[1:0], w_sum_node10w[1], w_sum_node10w[0]},
		w_decoder_node9w = {({dataa_node[18:0]} & {19{w_le_datab_node8w[9]}}), ({dataa_node[18:0]} & {19{w_le_datab_node8w[8]}}), ({dataa_node[18:0]} & {19{w_le_datab_node8w[7]}}), ({dataa_node[18:0]} & {19{w_le_datab_node8w[6]}}), ({dataa_node[18:0]} & {19{w_le_datab_node8w[5]}}), ({dataa_node[18:0]} & {19{w_le_datab_node8w[4]}}), ({dataa_node[18:0]} & {19{w_le_datab_node8w[3]}}), ({dataa_node[18:0]} & {19{w_le_datab_node8w[2]}}), ({dataa_node[18:0]} & {19{w_le_datab_node8w[1]}}), ({dataa_node[18:0]} & {19{w_le_datab_node8w[0]}})},
